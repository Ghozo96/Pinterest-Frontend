  ...
  return (
    <Fragment>
      <div className="d-flex flex-column align-items-center">
        <div className="d-flex ">
          ...
          <div className="dropdown mt-4">
            ...
            >
              ...
              <li className="mx-2 ">
                <Link class="dropdown-item  fw-bolder" id="setting-elem" to="#">
                  Edit Board
                </Link>
              </li>
              <li className="mx-2 ">
        ...
        <div >
		<img className="rounded-circle my-3" id="profile_img" src="https://i.pinimg.com/736x/b8/ce/d9/b8ced96199e56d254419afc00347769c.jpg" alt="your image"></img>
		</div>
