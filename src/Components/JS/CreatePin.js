...
class CreatePin extends Component {
    ...
    handleSubmit = async (e) => {
        ...
        if(this.WebsiteInValid(e.target.destination_link.value) && e.target.destination_link.value ){
            ...
            var formdata = new FormData();
                ...
                if (this.state.changedPP){
                    formdata.append('pin_picture', e.target.pin_picture.files[0] ,  e.target.pin_picture.files[0].name);
                }
	...
	render(){
		...
		return (
			<div className='container'>
			    <form onSubmit={this.handleSubmit} className='pinContainerCreate my-5 text-start p-4'> 
                    ...
                    <div className='optionsBar d-flex align-items-center align-content-center justify-content-center mb-3'>
                        <div className='d-flex align-items-center align-content-center flex-wrap'>
                            ...
                            <div> 
                                <button type='submit' className='btn m-1 btn-danger rounded-pill'> Save </button> 
                            </div>                       
                        </div>
                    </div>
                </form>
